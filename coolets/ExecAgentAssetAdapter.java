...
public class ExecAgentAssetAdapter extends Asset {
  ...
  /**
   * Get the schedule for this <code>ExecAgentAsset</code>
   * @return the Asset schedule
   */
  ...
  /**
   * Set the schedule for this <code>ExecAgentAsset</code>
   * @param the Asset new schedule
   */
