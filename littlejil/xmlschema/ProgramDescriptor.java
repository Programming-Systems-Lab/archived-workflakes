...
**/
public class ProgramDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProgramDescriptor() {
        ...
        //-- _diagramList
        desc = new XMLFieldDescriptorImpl(Diagram.class, "_diagramList", "diagram", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object )
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Program target = (Program) object;
                    target.addDiagram( (Diagram) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _diagramList
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(1);
        desc.setValidator(fieldValidator);
