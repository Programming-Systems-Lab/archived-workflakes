...
**/
public class PostrequisiteDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PostrequisiteDescriptor() {
        super();
        xmlName = "postrequisite";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                Postrequisite target = (Postrequisite) object;
