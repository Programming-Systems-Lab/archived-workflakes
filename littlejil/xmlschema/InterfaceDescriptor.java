...
public class InterfaceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InterfaceDescriptor() {
        ...
        //-- _items
        desc = new XMLFieldDescriptorImpl(InterfaceItem.class, "_items", (String)null, NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object )
                throws IllegalStateException
            {
                Interface target = (Interface) object;
                return target.getInterfaceItem();
            }
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Interface target = (Interface) object;
                    target.addInterfaceItem( (InterfaceItem) value);
                }
                catch (Exception ex) {
        ...
        desc.setClassDescriptor(new InterfaceItemDescriptor());
