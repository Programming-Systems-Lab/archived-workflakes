...
**/
public class CollectionDecl implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static CollectionDecl unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (CollectionDecl) Unmarshaller.unmarshal(CollectionDecl.class, reader);
    } //-- CollectionDecl unmarshal(java.io.Reader) 
