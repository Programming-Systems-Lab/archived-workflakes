...
public class Prerequisite implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static Prerequisite unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (Prerequisite) Unmarshaller.unmarshal(Prerequisite.class, reader);
    } //-- Prerequisite unmarshal(java.io.Reader) 
