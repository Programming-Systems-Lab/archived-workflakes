...
**/
public class ResourceDecl implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static ResourceDecl unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (ResourceDecl) Unmarshaller.unmarshal(ResourceDecl.class, reader);
    } //-- ResourceDecl unmarshal(java.io.Reader) 
