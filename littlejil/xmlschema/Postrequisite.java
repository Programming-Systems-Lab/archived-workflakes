...
**/
public class Postrequisite implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static Postrequisite unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (Postrequisite) Unmarshaller.unmarshal(Postrequisite.class, reader);
    } //-- Postrequisite unmarshal(java.io.Reader) 
