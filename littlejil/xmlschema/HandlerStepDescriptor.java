...
**/
public class HandlerStepDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public HandlerStepDescriptor() {
        super();
        xmlName = "handler-step";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                HandlerStep target = (HandlerStep) object;
