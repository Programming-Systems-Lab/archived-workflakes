...
**/
public class ExceptionDeclDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ExceptionDeclDescriptor() {
        super();
        xmlName = "exception-decl";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                ExceptionDecl target = (ExceptionDecl) object;
