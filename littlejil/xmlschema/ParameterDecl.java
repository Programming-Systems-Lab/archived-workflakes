...
**/
public class ParameterDecl implements java.io.Serializable {
    ...
    private ParameterDeclModeType _mode;
    ...
    **/
    public psl.workflakes.littlejil.xmlschema.types.ParameterDeclModeType getMode()
    {
        return this._mode;
    } //-- types.ParameterDeclModeType getMode() 
    ...
    **/
    public void setMode(psl.workflakes.littlejil.xmlschema.types.ParameterDeclModeType mode)
    {
        this._mode = mode;
    } //-- void setMode(types.ParameterDeclModeType) 
     ...
     * @param reader
    **/
    public static ParameterDecl unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (ParameterDecl) Unmarshaller.unmarshal(ParameterDecl.class, reader);
    } //-- ParameterDecl unmarshal(java.io.Reader) 
