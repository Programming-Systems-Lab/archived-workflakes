...
**/
public class MessageDeclDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MessageDeclDescriptor() {
        super();
        xmlName = "message-decl";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                MessageDecl target = (MessageDecl) object;
