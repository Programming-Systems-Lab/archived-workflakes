  ...
  implements NewSkillsPG, Cloneable
{
  ...
  public final static class DQ extends SkillsPGImpl implements org.cougaar.domain.planning.ldm.dq.NewHasDataQuality {
   public DQ() {
    super();
   }
  ...
  public final org.cougaar.domain.planning.ldm.dq.DataQuality getDataQuality() { return SkillsPGImpl.this.getDataQuality(); }
    public Class getPrimaryClass() {
      return primaryClass;
    }
    public String getAssetGetMethod() {
